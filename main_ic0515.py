...
def run(args):
    ...
    # ----------------------------------------
    # Full
    # args.exp_name = args.task_name + f'_run_{args.kge}' + f'_dim({args.dim})' + f'_gnn({args.num_layers})' + f'_cltemp({args.cl_temp})' + f'_beta({args.beta})' + time.strftime(
    #     "[%Y-%m-%d__%H-%M-%S]", time.localtime())
    #for Wo GCL-R
    # args.exp_name = args.task_name + f'_run_{args.kge}_'+'Wo GCL-R'
    # for Wo GCL-E
    # args.exp_name = args.task_name + f'_run_{args.kge}_' + 'Wo GCL-E'
    # for W/o SeCL
    # args.exp_name = args.task_name + f'_run_{args.kge}_' + 'Wo SeCL'
    # for W/o VGAE
    args.exp_name = args.task_name + f'_run_{args.kge}_' + 'Wo VGAE'
    # args.exp_name = args.task_name + f'_run_{args.kge}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='./data/icews05-15/day/icews05-15_ext.pkl') #icews05-15 icews14 day month
    ...
    parser.add_argument('--num_step', default=800, type=int) #100000
    parser.add_argument('--log_per_step', default=10, type=int) #10
    parser.add_argument('--check_per_step', default=800, type=int) #30
    ...
    parser.add_argument('--cpu_num', default=0, type=float)
    ...
    run(args)
    # for cl_temp in [0.02,0.2,0.5,1]:
    #     args.cl_temp = cl_temp
    #     run(args)
