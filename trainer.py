...
class Trainer(object):
    ...
    def evaluate(self, istest=False, num_cand='all'):
        if not istest:
            ...
            ent_emb, ent_emb_out, rel_emb, rel_emb_out, time_emb, time_emb_out, metarel_emb, metarel_emb_out = self.get_eval_emb(self.valid_data)

            results, count = self.get_rank(eval_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand)
            ...
            ent_emb, ent_emb_out, rel_emb, rel_emb_out, time_emb, time_emb_out, metarel_emb, metarel_emb_out = self.get_eval_emb(self.test_data)
            ...
            uent_results, uent_count = self.get_rank2(uent_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "uent")
            urel_results, urel_count = self.get_rank2(urel_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "urel")
            utime_results, utime_count = self.get_rank2(utime_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "utime")
            uentrel_results, uentrel_count = self.get_rank2(uentrel_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "uentrel")
            uenttime_results, uenttime_count = self.get_rank2(uenttime_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "uenttime")
            ureltime_results, ureltime_count = self.get_rank2(ureltime_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "ureltime")
            uall_results, uall_count = self.get_rank2(uall_dataloader, ent_emb+ent_emb_out, rel_emb+rel_emb_out, time_emb+time_emb_out, num_cand, "uall")
